...
if __name__ == '__main__':
    ...
    list_of_pokemon = [Charizard, Blastoise, Venusaur, Charmander, Squirtle, Bulbasaur, Charmeleon, Wartortle, Ivysaur]


    for i in range(len(list_of_pokemon)):
        print(f"{i+1}.", list_of_pokemon[i].name)
    index1 = int(input('Pick your Pokemon: '))-1
    choice1 = list_of_pokemon[index1]
    print(choice1)
    for i in range(len(list_of_pokemon)):
        print(f"{i+1}.", list_of_pokemon[i].name)
    index2 = int(input('Pick a opposing Pokemon: '))-1
    choice2 = list_of_pokemon[index2]    
    choice1.fight(choice2) # Get them to fight
